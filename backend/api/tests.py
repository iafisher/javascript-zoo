...
class ApiTests(TestCase):
    ...
    def test_task_create(self):
        ...
        task = Task.objects.get(pk=response["id"])
        self.assertEqual(response, task.json())
    ...
    def test_task_update_description(self):
        payload = {"id": self.task.pk, "description": "update_description text"}
        response = self._post_json("update_task_description", payload)
    ...
    def test_task_update_status(self):
        payload = {"id": self.task.pk, "status": Task.STATUS_COMPLETED}
        response = self._post_json("update_task_status", payload)
        self.task.refresh_from_db()
    ...
    def test_task_delete(self):
        ...
        payload = {"id": self.task.pk}
        response = self._post_json("delete_task", payload)
    ...
    def test_project_create(self):
        ...
        self.assertEqual(response, project.json())
        self.assertEqual(project.name, "new project")
        self.assertEqual(project.description, "project description")

    def test_project_update_description(self):
        payload = {"id": self.project.pk, "description": "new description"}
        response = self._post_json("update_project_description", payload)
        self.project.refresh_from_db()
        self.assertEqual(self.project.description, "new description")

    def test_project_delete(self):
        payload = {"id": self.project.pk}
        response = self._post_json("delete_project", payload)
